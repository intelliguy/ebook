...
public class DBHelper extends SQLiteHelper {
	...
	public int guessAuthor(String name){
		return 100;
	}
	public int guessTitle(String title){
		return 100;
	}
	...
	public static void main(String[] args) {
		try {
			...
			ResultSet rs = dbStmt
//			.executeQuery("SELECT DISTINCT title FROM book ");
			.executeQuery("SELECT DISTINCT author FROM book ");
//			.executeQuery("SELECT name FROM author ");
